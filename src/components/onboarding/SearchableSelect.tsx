    ...
    return (
      <div className="space-y-2">
        <label className="flex items-center gap-2 text-sm font-semibold text-slate-900">
          {labelIcon && (
            <span className="text-[#3A63B8]">{labelIcon}</span>
          )}
        ...
        <div
          role="status"
          className="flex h-12 w-full items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 text-base text-slate-400"
        >
          <svg
    ...
    return (
      <div className="space-y-2">
        ...
        <div
          role="alert"
          aria-live="assertive"
          className="flex w-full items-center justify-between rounded-xl border border-red-200 bg-red-50 p-3"
        >
        ...
        >
          {filtered.length === 0 ? (
            ...
            >
              {search.trim() ? (
                <span>
                  No results. Press <strong>Enter</strong> to use "
                  {search.trim()}"
                </span>
              ) : (
          ...
          {filtered.length > 50 && (
            <li className="px-4 py-2 text-center text-xs text-slate-400">
              Type to narrow down {filtered.length - 50}+ more
              results
            </li>
          )}
        </ul>
